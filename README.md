...
## 9. Checklist triển khai bộ quy chuẩn này (1 tuần)

- [ ] **Ngày 1**: Tạo repo `docs/`, copy các template vào `_templates/`
- [ ] **Ngày 2**: Tạo bộ prompt trong `_ai-prompts/` (clone từ tài liệu này)
- [ ] **Ngày 3**: Setup CI lint frontmatter (remark + custom rule)
- [ ] **Ngày 4**: Migrate 1 feature đang làm sang format mới (pilot)
- [ ] **Ngày 5**: Train team 1 buổi 90 phút, demo với feature pilot
- [ ] **Ngày 6**: Đặt `.claude/CLAUDE.md` và `AGENTS.md` ở root repo
- [ ] **Ngày 7**: Retrospective, fine-tune
